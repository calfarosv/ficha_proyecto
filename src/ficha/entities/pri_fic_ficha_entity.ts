...
export class Pri_Fic_Ficha_Entity {
    ...
    ficFormulSn?: string;
    @Column("date", { name: "FIC_FOR_FEPINI" })
    ficForFepini?: Date;
    @Column("date", { name: "FIC_FOR_FEPFIN" })
    ficForFepfin?: Date;
    @Column("date", { name: "FIC_FOR_FERINI" })
    ficForFerini?: Date;
    @Column("date", { name: "FIC_FOR_FERFIN" })
    ficForFerfin?: Date;
    @Column("varchar2", { name: "FIC_AMBIEN_SN", length: 1 })
    ficAmbienSn?: string;
    @Column("date", { name: "FIC_AMB_FEPINI" })
    ficAmbFepini?: Date;
    @Column("date", { name: "FIC_AMB_FEPFIN" })
    ficAmbFepfin?: Date;
    @Column("date", { name: "FIC_AMB_FERINI" })
    ficAmbFerini?: Date;
    @Column("date", { name: "FIC_AMB_FERFIN" })
    ficAmbFerfin?: Date;
    @Column("varchar2", { name: "FIC_CONTRA_SN", length: 1 })
    ficContraSn?: string;
    @Column("date", { name: "FIC_CON_FEPINI" })
    ficConFepini?: Date;
    @Column("date", { name: "FIC_CON_FEPFIN" })
    ficConFepfin?: Date;
    @Column("date", { name: "FIC_CON_FERINI" })
    ficConFerini?: Date;
    @Column("date", { name: "FIC_CON_FERFIN" })
    ficConFerfin?: Date;
    @Column("varchar2", { name: "FIC_EJECUT_SN", length: 1 })
    ficEjecutSn?: string;
    @Column("date", { name: "FIC_EJE_FEPINI" })
    ficEjeFepini?: Date;
    @Column("date", { name: "FIC_EJE_FEPFIN" })
    ficEjeFepfin?: Date;
    @Column("date", { name: "FIC_EJE_FERINI" })
    ficEjeFerini?: Date;
    @Column("date", { name: "FIC_EJE_FERFIN" })
    ficEjeFerfin?: Date;
    @Column("varchar2", { name: "FIC_LIQUID_SN", length: 1 })
    ficLiquidSn?: string;
    @Column("date", { name: "FIC_LIQ_FEPINI" })
    ficLiqFepini?: Date;
    @Column("date", { name: "FIC_LIQ_FEPFIN" })
    ficLiqFepfin?: Date;
    @Column("date", { name: "FIC_LIQ_FERINI" })
    ficLiqFerini?: Date;
    ...
    ficObservFic?: string;
    @Column("date", { name: "FIC_FECHA_VER" })
    ficFechaVer?: Date;
